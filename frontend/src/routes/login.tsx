...
function LoginPage() {
  // El login lo gestiona Auth0 (Universal Login). El backend inicia el flujo
  // OAuth 2.0 Authorization Code en /api/auth/login; Google queda detrás de Auth0.
  return (
    <AuthShell title="Bienvenido" subtitle="Inicia sesión con tu correo institucional ULS">
      <div className="space-y-4">
        ...
        <p className="text-center text-xs text-muted-foreground">
          Se usa tu cuenta institucional @ulasalle.edu.pe. La primera vez, tu
